...
+ (void)getWithURLString:(NSString *)URLString
    ...
    [[self shareSessionManager] POST:url parameters:parameters progress:^(NSProgress * _Nonnull downloadProgress) {
        if (progress) {     
...
+ (void)getWithURLString:(NSString *)URLString
              parameters:(NSDictionary *)parameters
                 success:(void (^)(id responseObject))success
                 failure:(void (^)(NSError *error))failure {
    NSString*  url = [NSString stringWithFormat:@"%@%@",HOST_URL,URLString];
    NSLog(@"url = %@,params = %@",url,parameters);
    [self getWithURLString:url parameters:parameters progress:^(NSProgress *downloadProgress) {
