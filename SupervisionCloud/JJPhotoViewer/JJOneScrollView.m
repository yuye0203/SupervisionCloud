    ...
    [UIView animateWithDuration:AnimationTime animations:^{
        ...
        self.superview.backgroundColor = [UIColor blackColor];
         ...
         self.userInteractionEnabled = YES ;
            ...
            //变换完动画 从网络开始加载图
            [self.mainImageView sd_setImageWithURL:[NSURL URLWithString:urlStr]
                                  placeholderImage:self.mainImageView.image
                                           options:SDWebImageRetryFailed|SDWebImageLowPriority
                                          progress:^(NSInteger receivedSize, NSInteger expectedSize,NSURL * _Nullable targe) {
